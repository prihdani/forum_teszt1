            ...
            <CardBody>
              <Box as="form" onSubmit={formik.handleSubmit}>
                <Stack spacing='5'>
                  ...
                  <Button colorScheme="blue" mt="5" type="submit" isLoading={isLoading} isDisabled={!formik.isValid || formik.isSubmitting} 
                  bg='black' color='white' size='sm' onClick={handleSubmitClick}>
                    Regisztráció
                  </Button>
                  <Button variant="outline" mt="5" ml="5" onClick={() => formik.resetForm()} isDisabled={isLoading} size='sm'>
                    Mégsem
                  </Button>
                </Stack>
              </Box>
